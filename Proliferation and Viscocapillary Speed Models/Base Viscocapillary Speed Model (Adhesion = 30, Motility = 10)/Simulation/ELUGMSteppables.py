...
BASALYB=10 #baseline motility for L929, due to their extremely motile behaviour
BASALGR=1
SCF=0.5 #self-attenuator weighing basal motility vs loss of motility due to adhesion
#Self-Cutoff
ENDMCS=24010 #call runtime here directly
#Mitosis Variables
...
MTFORCEMIN=-3*10**(-4.9) #negative mitosis driving force fluctuation, usually only need to change the exponential part
MTFORCEMAX=4*10**(-4.9)  #positive mitosis driving force fluctuation, usually change only the exponential part
#Signaling Variables
...
THRESHOLDUPYG=10000 #activation threshold to change state  
