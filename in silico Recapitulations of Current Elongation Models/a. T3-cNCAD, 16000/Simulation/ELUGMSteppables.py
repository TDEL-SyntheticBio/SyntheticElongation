...
BASALB=25
BASALGR=24 #, A', B'' T0, change GR to 100 - see what happens 
...
MTFORCEMIN3=-3*10**(-4.660) #negative mitosis driving force fluctuation, usually only need to change the exponential part
MTFORCEMAX3=4*10**(-4.660)  #positive mitosis driving force fluctuation, usually change only the exponential part
MTFORCEMIN4=-3*10**(-4.660) #negative mitosis driving force fluctuation, usually only need to change the exponential part
MTFORCEMAX4=4*10**(-4.660)  #positive mitosis driving force fluctuation, usually change only the exponential part
#Signaling Variables
...
THRESHOLDUPYG=16000 #activation threshold to change state, NOTE: line 38 was another set of parameters  
...
THRESHOLDUPBR=16000 #activation threshold to change state, the choice of paramters in this paragraph render it similar to that of the previous paragraph
