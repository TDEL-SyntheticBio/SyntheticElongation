...
BASALB=26
BASALGR=22 #, A', B'' T0, change GR to 100 - see what happens 
...
MTFORCEMIN3=-3*10**(-4.713) #negative mitosis driving force fluctuation, usually only need to change the exponential part
MTFORCEMAX3=4*10**(-4.713)  #positive mitosis driving force fluctuation, usually change only the exponential part
MTFORCEMIN4=-3*10**(-4.861) #negative mitosis driving force fluctuation, usually only need to change the exponential part
MTFORCEMAX4=4*10**(-4.861)  #positive mitosis driving force fluctuation, usually change only the exponential part
#Signaling Variables
