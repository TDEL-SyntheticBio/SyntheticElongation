...
BASALB=22
BASALGR=21 #, A', B'' T0, change GR to 100 - see what happens 
...
MTFORCEMIN3=-3*10**(-4.806) #negative mitosis driving force fluctuation, usually only need to change the exponential part
MTFORCEMAX3=4*10**(-4.806)  #positive mitosis driving force fluctuation, usually change only the exponential part
MTFORCEMIN4=-3*10**(-5.024) #negative mitosis driving force fluctuation, usually only need to change the exponential part
MTFORCEMAX4=4*10**(-5.024)  #positive mitosis driving force fluctuation, usually change only the exponential part
#Signaling Variables
