...
BASALYB=100 #baseline motility for L929, due to their extremely motile behaviour, A, B
BASALGR=1 #, A', B'' T0, change GR to 100 - see what happens 
...
MTFORCEMIN=-3*10**(-4.102) #negative mitosis driving force fluctuation, usually only need to change the exponential part
MTFORCEMAX=4*10**(-4.102)  #positive mitosis driving force fluctuation, usually change only the exponential part
#Signaling Variables
...
THRESHOLDUPBR=10000 #activation threshold to change state, the choice of paramters in this paragraph render it similar to that of the previous paragraph
